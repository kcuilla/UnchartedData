...
In late 2020, RStudio announced they were hosting an inaugural table [contest](https://blog.rstudio.com/2020/09/15/announcing-the-2020-rstudio-table-contest/). I decided to create a dynamic table that displayed the team ratings and stats from every NFL team from the 2019 season. The data is scraped from Pro Football Reference and the table was created with the `reactable` package with some CSS styling sprinkled in. 

My submission received an Honorable Mention [award](https://blog.rstudio.com/2020/12/23/winners-of-the-2020-rstudio-table-contest/) from RStudio among 80+ entries.

See the table below as well as the [code](https://github.com/kcuilla/2020-RStudio-Table-Contest) for the table located on my GitHub.

<i>Note: if you are viewing on a mobile device, click [here](https://rpubs.com/kcuilla/nfl_team_ratings) to see the full output of the table.</i>
